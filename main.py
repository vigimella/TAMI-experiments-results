    ...
    for path in sub_path_list:
        ...
        for file in os.listdir(path):
            ...
            if file.endswith('.results'):
                ...
                elif 'load_model =' in text_file_new and 'test loss:' in text_file_new:
                    file_to_check.append(file_elm)
